...
class _PengaduanPageState extends State<PengaduanPage> {
  ...
  Future<void> _fetchPengaduan() async {
    ...
    try {
      if(jabatan == "Ketua RT"){
        final kinerjaResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Kinerja"));
        final fasilitasResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Fasilitas"));
        ...
        final kegiatanResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Kegiatan"));
        ...
        final keuanganResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Keuangan"));
        ...
        final kebersihanResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Kebersihan"));
        ...
        final keamananResponse = await http.get(Uri.parse("https://pexadont.agsa.site/api/pengaduan/jenis/Keamanan"));
  ...
  void _balasPengaduan(String id_pengaduan, String balasan) async {
    var request = http.MultipartRequest('POST', Uri.parse('https://pexadont.agsa.site/api/pengaduan/balas'));
        ...
        if (constraints.maxWidth > 600) {
          ...
          return Column(
            children: [
              ...
              Text('Menampilkan pengaduan untuk ${jabatan ?? "-"}'),
                                        ...
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                              ...
                                              _balasPengaduan(pengaduan['id_pengaduan'], message);
